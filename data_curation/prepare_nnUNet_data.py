...
def prepare_nnUNet_data(proj_dir, data_dir, data_type):
    ...
    if data_type == 'train':
        ...
        seg_crop_dir = proj_dir + '/TCIA/seg_p_n_crop_new'
        ...
        img_crop_dir = '/mnt/aertslab/USERS/Zezhong/HN_OUTCOME/TCIA/HGJ_HMR_data/crop_img'
        seg_crop_dir = '/mnt/aertslab/USERS/Zezhong/HN_OUTCOME/TCIA/HGJ_HMR_data/crop_seg_pn'
    ...
    ### external test dataset: test2
        ...
        df.to_csv(data_dir + '/df_ts2_pn.csv', index=False)
        # img dataset without seg
        img_nn_ids = []
        for i, img_dir in enumerate(df_noseg['img_dir']):
            ...
            img_nn_ids.append(img_nn_id)
        df_noseg['img_nn_id'] = img_nn_ids
        df_noseg.to_csv(data_dir + '/df_no_seg_pn2.csv', index=False)
