...
def reg_crop(proj_dir, root_dir, image_format, crop_shape):
    ...
    interp_img_dir = proj_dir + '/TOT/interp_img'
    interp_seg_dir = proj_dir + '/TOT/interp_seg'
    crop_img_dir = '/mnt/HDD_6TB/HN_Outcome/TOT/crop_img'
    crop_seg_dir = '/mnt/HDD_6TB/HN_Outcome/TOT/crop_seg'
    ...
    for img_dir in img_dirs:
        ...
        for seg_dir in seg_dirs:
            seg_id = seg_dir.split('/')[-1].split('.')[0]
            if img_id == seg_id:
                if 'PMH_5' in img_id or 'PMH_6' in img_id:
                    count += 1
                    print(count, img_id)
