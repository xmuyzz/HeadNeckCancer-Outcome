...
def split_dataset(proj_dir):
    ...
    df_develop = df.loc[df['groupid'].isin(['CHUM', 'CHUS', 'PMH'])]
    df_test = df.loc[df['groupid'].isin(['MDACC'])]
    ...
    fns_train = ['df_train0.csv', 'df_train1.csv', 'df_train2.csv', 'df_train3.csv', 'df_train4.csv']
    fns_val = ['df_val0.csv', 'df_val1.csv', 'df_val2.csv', 'df_val3.csv', 'df_val4.csv']
    ...
    print('train, val and test dataframes have been saved!!!')
