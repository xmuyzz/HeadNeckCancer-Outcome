...
def risk_strat(opt, task, dataset, cox_type, score_type, hpv, n_group, surv_type, cluster_model, random_state, surv_csv):
    ...
    df = df_tot
    x = df.drop(columns=[times, events]).values
...
if __name__ == '__main__':
    ...
    for dataset in ['va2', 'ts2', 'tx_bwh', 'tx_maastro']:
        risk_strat(opt, task, dataset, cox_type, score_type, hpv, n_group, surv_type, cluster_model, random_state, surv_csv)